                ...
                <div class="row-fluid">
                    ...
                    <div class="span6">
                        ...
                        <form class="form-horizontal" method="post">
                            ...
                            <div class="control-group">
                                <div class="controls">
                                    <button type="submit" name="login" class="btn btn-info"><i class="icon-signin icon-large"></i>&nbsp;Login in</button>
                                 
                                </div>
                             <br>
                               <div class="alert alert-info"><strong>Sign in</strong> New to E-Learning </div>
                               <a href="signin.php">  <button type="button" name="sign in" class="btn btn-info    signin"><i class="icon-signin icon-large"></i>&nbsp;Sign in</button></a>
                                ...
                                if (isset($_POST['login'])) {
                                    ...
                                    if ($count > 0) {
                                        ...
                                        echo('<script>location.href = "invalid_login.php"</script>');
